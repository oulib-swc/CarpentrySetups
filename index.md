...
venue: "Software setups for Carpentry workshops"        # brief name of host site without address (e.g., "Euphoric State University")
...
instructor: ["For learners not participating in a Carpentry workshop but needing to setup the various softwares."] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
<div id="sql"> {% comment %} Start of 'SQLite' section. {% endcomment %}
  ...
  <p> Carpentries is now usinsg a tool called DB Browser for SQLite. The install is for <a href="http://sqlitebrowser.org/">all platforms</a>.
  </p>
